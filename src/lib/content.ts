...
export const about = {
  ...
  intro:
    "No somos la barrita del gym. Tampoco la barrita 'healthy' de la gasolinera. Somos la que nadie se había atrevido a hacer bien: un snack pensado para el día a día, con sabor de verdad, macros que cuadran e ingredientes que reconoces a la primera.",
  story: {
  ...
  posts: [
    ...
    },
    {
      ...
      body: [
        ...
        "## Los números de CRUSH",
        "Aquí es donde nos gusta enseñar los números que sí tenemos. En la analítica de laboratorio independiente de [CRUSH](/tienda), realizada por Mérieux NutriSciences, cada barrita aporta el ==31% de los valores de referencia de nutrientes (VRN) de hierro==, además de contener zinc y vitamina B12. Son datos medidos, no estimaciones de folleto.",
        ...
        "## Un snack más inteligente",
        "No te vamos a decir que una barrita sustituya a una dieta variada, porque no lo hace ni debería. Lo que sí puede hacer es ser una elección más inteligente cuando pica el hambre entre horas: en vez de un dulce vacío, un snack que suma **proteína, fibra y micronutrientes** que de verdad tu cuerpo utiliza. ¿Te preguntas por qué grillo? Lo explicamos en [por qué proteína de grillo](/blog/por-que-proteina-de-grillo).",
      ],
    },
    {
      ...
      body: [
        ...
        "En [CRUSH](/tienda) parte de esa fibra viene de la achicoria, de la que se obtiene la inulina, una fibra vegetal que además aporta un toque de textura y dulzor sin necesidad de azúcares añadidos. Es un ingrediente real, reconocible, que cumple una función clara y no está ahí solo para engordar la lista.",
        ...
        "## Cómo elegir mejor",
        "La próxima vez que compares barritas, no te quedes solo en el gramaje de proteína. Baja un par de líneas y busca la fibra. Es un detalle pequeño en la etiqueta que dice mucho sobre si tienes delante comida pensada para nutrir o un dulce con buena campaña de marketing. Y si quieres aprender a leerlas bien, no te pierdas [cómo leer una etiqueta](/blog/leer-una-etiqueta).",
      ],
    },
    {
    ...
    },
    {
      ...
      body: [
        ...
        "En [AnyBug](/tienda) hacemos justo lo contrario de esconder. La etiqueta de CRUSH es corta y reconocible: dátiles, cacao, fibra vegetal de achicoria, proteína de arroz, proteína de guisante, harina de grillo, aceite de oliva virgen extra y concentrado de zumo de uva. Sin edulcorantes artificiales y sin azúcares añadidos, porque el dulzor viene de la fruta.",
    ...
    },
    {
      ...
      body: [
        ...
        "## ¿Se nota el sabor?",
        "La respuesta sincera es que no. En [CRUSH](/tienda) la harina de grillo está al **10,4%** y se integra con dátiles, cacao y el resto de ingredientes, así que lo que saboreas es una barrita de chocolate rica, no un grillo. La idea da más respeto que el sabor, te lo aseguramos.",
